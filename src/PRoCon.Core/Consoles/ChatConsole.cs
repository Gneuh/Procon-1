    ...
    public class ChatConsole : Loggable {
        ...
        private void m_prcClient_Chat(FrostbiteClient sender, List<string> rawChat) {
            ...
            */
            ...
            if (System.String.Compare(rawChat[1], "ID_CHAT_REQUEST_MEDIC", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_REQUEST_ORDER", "uscChatPanel.ID_CHAT_REQUEST_ORDER");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_REQUEST_ORDER", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_REQUEST_MEDIC", "uscChatPanel.ID_CHAT_REQUEST_MEDIC");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_REQUEST_REPAIRS", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_REQUEST_REPAIRS", "uscChatPanel.ID_CHAT_REQUEST_REPAIRS");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_GOGOGO", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_GOGOGO", "uscChatPanel.ID_CHAT_GOGOGO");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_AFFIRMATIVE", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_AFFIRMATIVE", "uscChatPanel.ID_CHAT_AFFIRMATIVE");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_THANKS", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_THANKS", "uscChatPanel.ID_CHAT_THANKS");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_REQUEST_AMMO", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_REQUEST_AMMO", "uscChatPanel.ID_CHAT_REQUEST_AMMO");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_REQUEST_RIDE", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_REQUEST_RIDE", "uscChatPanel.ID_CHAT_REQUEST_RIDE");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_GET_OUT", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_GET_OUT", "uscChatPanel.ID_CHAT_GET_OUT");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_GET_IN", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_GET_IN", "uscChatPanel.ID_CHAT_GET_IN");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_NEGATIVE", System.StringComparison.OrdinalIgnoreCase) == 0) {
                rawChat[1] = Client.Language.GetDefaultLocalized("ID_CHAT_NEGATIVE", "uscChatPanel.ID_CHAT_NEGATIVE");
            }
            if (System.String.Compare(rawChat[1], "ID_CHAT_SORRY", System.StringComparison.OrdinalIgnoreCase) == 0) {
            ...
            if (System.String.Compare(rawChat[0], "server", System.StringComparison.OrdinalIgnoreCase) != 0) {
                if (rawChat.Count == 2) {
                    ...
                    if (int.TryParse(rawChat[3], out iTeamID) == true) {
                        formattedMessage = String.Format("^b^4{0}^0 - ^4{1}^0 >^4 {2}", rawChat[0], Client.GetLocalizedTeamName(iTeamID, Client.CurrentServerInfo.Map, Client.CurrentServerInfo.GameMode), rawChat[1]);
                    }
                }
                    ...
                    if (int.TryParse(rawChat[3], out iTeamID) == true) {
                        if (System.String.CompareOrdinal(rawChat[4], "0") != 0) {
                            formattedMessage = String.Format("^b^4{0}^0 - ^4{1}^0 - ^4{2}^0 >^4 {3}", rawChat[0], Client.GetLocalizedTeamName(iTeamID, Client.CurrentServerInfo.Map, Client.CurrentServerInfo.GameMode), Client.Language.GetLocalized("global.Squad" + rawChat[4], null), rawChat[1]);
                        }
                        else {
                            // TO DO: Localize and change uscPlayerListPanel.lsvPlayers.colSquad 
                            formattedMessage = String.Format("^b^4{0}^0 - ^4{1}^0 - ^4{2}^0 >^4 {3}", rawChat[0], Client.GetLocalizedTeamName(iTeamID, Client.CurrentServerInfo.Map, Client.CurrentServerInfo.GameMode), Client.Language.GetLocalized("uscPlayerListPanel.lsvPlayers.colSquad", null), rawChat[1]);
                        }
                    }
                }
